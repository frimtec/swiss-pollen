...
_POLLEN_URL = 'https://www.meteoschweiz.admin.ch/product/output/measured-values/stationsTable/messwerte-pollen-{}-1h/stationsTable.messwerte-pollen-{}-1h.{}.json'
...
class Station:
    ...
    def __str__(self):
        return f"Station(code={self.code}, name={self.name}, canton={self.canton}, altitude={self.altitude}, coordinates={self.coordinates}, latlong={self.latlong})"
